...
<body>
  ...
  <!-- Header -->
  <header class="w3-container w3-blue w3-center" style="padding:40px 16px">
...
<?php
# loop through each tuple in our "pokemon" result set and produce a Bootstrap card for each.
foreach ($statements as $sym) { ?>
